...
class Input(object):
    ...
    def add_event(cls, event):
        ...
        if event.type == KEYDOWN:
            ...
            Input.events.update({QUIT: [event, True]})
    ...
    @classmethod
    def isactive(cls, name):
        """
        Is the event in a down state or motion state.
        """
        return Input.stat(name) == Input.DOWN or Input.stat(name) == Input.MOTION
